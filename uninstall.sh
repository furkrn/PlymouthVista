...
SYSTEM_SYSTEMD_SERVICES=("update-plymouth-vista-state-boot.service" "update-plymouth-vista-state-quit.service" "plymouth-vista-hibernate.service" "plymouth-vista-resume-from-hibernation.service" "plymouth-vista-slow-boot-animation.service" "plymouth-vista-no-wall.service")
SKIP_QUESTION=0
